@echo off
xcopy /s "C:\Users\damie\source\repos\SubnauticaMod\ClientSubnautica\bin\Release\ClientSubnautica.dll" "E:\Jeux\Subnautica Below Zero\QMods\SubnauticaModTest" /Y
